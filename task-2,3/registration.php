...
<div class="container center col-lg-5 mt-5">
  <form class="form-background shadow" action="" method="Post" enctype="multipart/form-data">
    <div class="form-row pt-2">
      ...
      <div class="col-lg-5">
        <input type="text" name="txtName" value="" class="text-field" id="txtName">
      </div>
    </div>
    <div class="form-row pt-2">
      <div class="col-lg-5 pl-5">
    ...
    <div class="form-row pt-2">
      ...
      <div class="col-lg-5">
        <input type="checkbox" id="txtCourse" name="txtCourse" value=""> abcd <br>
        <input type="checkbox" id="txtCourse" name="txtCourse" value=""> abcd <br>
        <input type="checkbox" id="txtCourse" name="txtCourse" value=""> abcd <br>
        <input type="checkbox" id="txtCourse" name="txtCourse" value=""> abcd <br>
        <input type="checkbox" id="txtCourse" name="txtCourse" value=""> abcd
      </div>
    </div>
    <div class="form-row pt-2">
      <div class="col-lg-5 pl-5">
